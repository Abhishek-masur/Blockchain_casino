                ...
                <div className="xl:w-3/12 lg:w-3/12 md:w-8/12 md:mb-0 bg-white px-12 py-16 rounded-lg drop-shadow-md">
                    ...
                    <form>
                        ...
                        <div className="text-center">
                            <button
                                type="button"
                                className="inline-block px-10 py-3 bg-blue-600 text-white font-medium text-sm leading-snug uppercase rounded-md shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                                Create Account
                            </button>
                            <div className="text-center mb-6 pt-6 ">
                                <Link href="/login" className="text-gray-800 font-normal">Already registered? Login</Link>
                            </div>
                        </div>
                    </form>
                </div>
